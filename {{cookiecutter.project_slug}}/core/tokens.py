...
USER_CLAIM_ID = settings.SIMPLE_JWT.get("USER_ID_CLAIM", "user_id")
...
class SessionTokenObtainPairView(TokenObtainPairView):
    ...
    The class sets the serializer class as `SessionTokenObtainPairSerializer` which adds the session_id to the token
    data.
    """
...
class PasswordResetTokenObtainPairView(TokenObtainPairView):
    """
    View class that extends the functionality of TokenObtainPairView.
    The class sets the serializer class as `PasswordResetTokenObtainPairSerializer` which adds the user_id to the token
    data.
    """
...
class PasswordChangeTokenObtainPairView(TokenObtainPairView):
    """
    View class that extends the functionality of TokenObtainPairView.
    The class sets the serializer class as `PasswordChangeTokenObtainPairSerializer` which adds the user_id to the
    token data.
    """
